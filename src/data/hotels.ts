...
export const hotels: Hotel[] = [
  ...
  },
  {
    ...
    category: "Boutique Hotel",
    starRating: 5,
    description: "A restored 16th-century estate among rolling Tuscan vineyards. Wine tastings, truffle hunting, and Michelin-starred dining in the heart of Chianti.",
    price: 380,
    rating: 4.8,
    reviews: 1430,
    image: hotel2,
    images: [hotel2, hotel1, dest2, hotel5],
    amenities: ["Free WiFi", "Vineyard Tours", "Pool", "Restaurant", "Wine Cellar", "Spa", "Cooking Classes", "Garden"],
    rooms: [
      { id: "r28", name: "Vineyard View Room", price: 380, capacity: 2, beds: "1 King Bed", size: "36 m²", amenities: ["Vineyard View", "Wine Bar", "Antique Furnishings"] },
      { id: "r29", name: "Estate Suite", price: 690, capacity: 3, beds: "1 King + 1 Single", size: "85 m²", amenities: ["Private Terrace", "Living Room", "Fireplace", "Marble Bath"] },
    ],
    reviewsList: [
      { id: "rv18", author: "Lorenzo M.", avatar: "LM", rating: 5, date: "Mar 2026", comment: "The wine tasting at sunset was unforgettable." },
    ],
  },
  {
    id: "14",
    name: "Manhattan Skyline Tower",
    location: "New York, USA",
    category: "City Hotel",
    starRating: 5,
    description: "An ultra-modern luxury tower in Midtown Manhattan with floor-to-ceiling Central Park views, a rooftop lounge, and direct access to Fifth Avenue shopping.",
    price: 495,
    rating: 4.7,
    reviews: 3870,
    image: hotel4,
    images: [hotel4, hotel1, dest3, hotel2],
    amenities: ["Free WiFi", "Rooftop Bar", "Spa", "Restaurant", "Gym", "Business Center", "Concierge", "Valet Parking"],
    rooms: [
      { id: "r30", name: "Park View Deluxe", price: 495, capacity: 2, beds: "1 King Bed", size: "42 m²", amenities: ["Central Park View", "Smart Room", "Marble Bath"] },
      { id: "r31", name: "Skyline Penthouse", price: 1100, capacity: 4, beds: "2 King Beds", size: "140 m²", amenities: ["360° View", "Private Terrace", "Dining Room", "Butler"] },
    ],
    reviewsList: [
      { id: "rv19", author: "Rachel C.", avatar: "RC", rating: 5, date: "Feb 2026", comment: "Stunning views and impeccable service in the heart of NYC." },
    ],
  },
  {
    id: "15",
    name: "Patagonia Wilderness Retreat",
    location: "Torres del Paine, Chile",
    category: "Mountain Lodge",
    starRating: 4,
    description: "An eco-luxury lodge with floor-to-ceiling windows facing the Paine Massif. Guided treks, horseback riding, and sustainable gourmet cuisine.",
    price: 540,
    rating: 4.9,
    reviews: 410,
    image: hotel5,
    images: [hotel5, dest1, hotel1, hotel3],
    amenities: ["Free WiFi", "Restaurant", "Bar", "Guided Excursions", "Spa", "Sauna", "Library", "Stargazing"],
    rooms: [
      { id: "r32", name: "Mountain Pod", price: 540, capacity: 2, beds: "1 King Bed", size: "38 m²", amenities: ["Glacier View", "Heated Floor", "Soaking Tub"] },
      { id: "r33", name: "Wilderness Villa", price: 880, capacity: 4, beds: "2 Queen Beds", size: "95 m²", amenities: ["Panoramic View", "Living Room", "Private Guide", "Fireplace"] },
    ],
    reviewsList: [
      { id: "rv20", author: "Diego R.", avatar: "DR", rating: 5, date: "Jan 2026", comment: "Breathtaking landscapes and world-class hospitality." },
    ],
  },
  {
    id: "16",
    name: "Marrakech Riad Mirage",
    location: "Marrakech, Morocco",
    category: "Boutique Hotel",
    starRating: 4,
    description: "A hidden gem inside the historic Medina — an ornate riad with mosaic courtyards, rooftop hammam, and authentic Moroccan dining under the stars.",
    price: 215,
    rating: 4.7,
    reviews: 1640,
    image: dest3,
    images: [dest3, hotel2, hotel4, dest1],
    amenities: ["Free WiFi", "Hammam", "Pool", "Restaurant", "Rooftop Terrace", "Spa", "Tea Lounge", "Tour Desk"],
    rooms: [
      { id: "r34", name: "Courtyard Room", price: 215, capacity: 2, beds: "1 Queen Bed", size: "28 m²", amenities: ["Courtyard View", "Tadelakt Bath", "Berber Decor"] },
      { id: "r35", name: "Royal Riad Suite", price: 410, capacity: 3, beds: "1 King + 1 Single", size: "70 m²", amenities: ["Private Terrace", "Plunge Pool", "Hammam Access", "Lounge"] },
    ],
    reviewsList: [
      { id: "rv21", author: "Fatima Z.", avatar: "FZ", rating: 5, date: "Mar 2026", comment: "Truly magical — the rooftop dinner was a highlight of our trip." },
    ],
  },
];
